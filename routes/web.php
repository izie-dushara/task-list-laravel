...
Route::get('/', function () {
    // Redirect to the route that shows the list of completed tasks
...
Route::get('/tasks', function () {
    return view('index', [
        // Fetch all completed tasks, ordering them by creation date (newest first)
...
Route::post('/tasks', function (Request $request) {
    ...
    // Create a new task and fill it with the validated data
    $task = new Task();
